...
if(typeof window === 'undefined') {
  ...
  async function handleFetch(request) {
    ...
    if(request.credentials.toLowerCase() === "same-origin" && request.method.toLowerCase() === "get" && request.url.includes("/assets/assets/")) {
      // Fix for the assets path
      request = new Request(request.url.replace("/assets/assets/", "/assets/"), {
        cache: request.cache,
        credentials: "omit",
        headers: request.headers,
        integrity: request.integrity,
